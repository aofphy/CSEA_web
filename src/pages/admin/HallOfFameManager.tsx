...
export default function HallOfFameManager() {
  const { hallOfFame, addHallOfFame, updateHallOfFame, deleteHallOfFame } = useData();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {hallOfFame.map((item) => (
          <div key={item.id} className="bg-card p-4 rounded-lg border flex gap-4 items-start">
